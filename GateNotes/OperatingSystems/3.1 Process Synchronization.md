...
- Progress
	- When no process are executing the critical section
		- If a n processes desires to enter critical section, the selection of a process to enter the CS should be made immediately
...
- **Drawback**
	...
	- This is a software based solution as no support form the OS and hardware are required
